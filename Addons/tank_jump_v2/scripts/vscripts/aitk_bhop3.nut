...
if (Director.GetGameModeBase()=="realism"&&!Entities.FindByName(null, "bind_tkhop")) {SpawnEntityFromTable("logic_timer",{targetname="bind_tkhop",vscripts="aitk_bhop",RefireTime = 0.5 , OnTimer = "!caller,runscriptcode,Thinks()"});}
function Thinks()
{
    local i,ent;
    for(i=0;i<16;i++)
